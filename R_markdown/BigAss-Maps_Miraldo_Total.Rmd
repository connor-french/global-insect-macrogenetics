...
#read in data
total_data <- read.csv("Miraldoetal_GPS-total.csv")
```
...
100x100 km. Dataset is reduced from 2439 to 267 species and from 45933 observations to 11508 observations. (species: length(unique(pts_ext_1d$Species_name)) / observations:str(pts_ext_1d))
```{r}
...
200x200 km. 2439 to 280 species and from 45933 observations to 11905 observations. (species: length(unique(pts_ext_2d$Species_name)) / observations:str(pts_ext_2d))
...
300x300 km. 2439 to 290 species and from 45933 observations to 12078 observations. (species: length(unique(pts_ext_3d$Species_name)) / observations:str(pts_ext_3d))
